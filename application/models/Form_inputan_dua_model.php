...
class Form_inputan_dua_model extends CI_Model
{

    public $table = 'form_inputan_dua';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function json() {
        ...
        $this->datatables->from('form_inputan_dua');
        //add this line for join
        //$this->datatables->join('table2', 'form_inputan_dua.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('form_inputan_dua/detail/$1'),'<i class="fa fa-book"></i>Read','class="btn btn-info btn-xs edit"')."  ".anchor(site_url('form_inputan_dua/edit/$1'),'<i class="fa fa-edit"></i> Update','class="btn btn-success btn-xs edit"')."<a href='#' class='btn btn-danger btn-xs delete' onclick='javasciprt: return hapus($1)'><i class='fa fa-trash'></i> Delete</a>", 'id');
