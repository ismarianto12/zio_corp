...
class Admin extends CI_Controller {
                ...
                $this->m_user->add($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(site_url() . '/admin/akundinas' , 'refresh');
    ...
    public function akundinas_del($kode)
    {
        ...
        redirect(site_url() . '/admin/akundinas/','reload');   
    }
        ...
        {*/
            if(!empty($_POST))
            {
                ...
                $this->m_user->add($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(site_url() . '/admin/bupati' , 'refresh');
    ...
    public function bupati_del($kode)
    {
        if(IS_TEST === 'FALSE')
        {
           ...
           redirect(site_url() . '/admin/bupati/','reload');   
    }
    ...
    public function deletemessage()
    {
        ...
        redirect(site_url() . '/admin/message/', 'reload');
    }
    ...
    public function hapusdetailmessage()
    {
        ...
        redirect(site_url() . '/admin/detailmessage/'.$id_message,'reload');
    }
        ...
        else
        {
            ...
            $id_message = (int)$this->uri->segment(3);
             ...
             if(!empty($_POST))
             {
                ...
                redirect(site_url() . '/admin/detailmessage/'.$id_message, 'refresh');
             }
            ...
            if(!empty($_POST)){
                ...
                if($this->form_validation->run() == TRUE)
                {
                    ...
                    if(IS_TEST === 'FALSE')
                    {
                        ...
                        $data['clear_text_box'] = 'TRUE';   
                        redirect(site_url() . '/admin/myprofile' , 'refresh');
    ...
    public function member()
    {
     ...
     function member_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/member/','reload');
    }
    ...
    function profile_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/profile/','reload');
    }
 ...
 public function detailfasilitas($id)
            ...
            if(!empty($_POST))
            {
                ...
                if($this->form_validation->run() == TRUE)
                {
                    ...
                    $this->m_fasilitas->add($data); 
                     ...
                     $this->session->set_flashdata('message', 'Data sudah disimpan');
                         $data['clear_text_box'] = 'TRUE';   
                          redirect(site_url() . '/admin/fasilitas' , 'refresh');
    ...
    function fasilitas_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/fasilitas/','reload');
    }
...
// }
    ...
    public function deletenews()
    {
        ...
        redirect(site_url() . '/admin/news/', 'reload');
    }
    ...
    public function hapusdetailnews()
    {
        ...
        redirect(site_url() . '/admin/detailnews/'.$id_news,'reload');
    }
        ...
        if(!empty($_POST))
         {
            ...
            redirect(site_url() . '/admin/detailnews/'.$id_news, 'refresh');
         }
           ...
           if(!empty($_POST)){
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $this->m_quiz->saveAnswer($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(base_url() . 'admin/sayembara' , 'refresh');
    ...
    public function sayembara_hasil()
    {
        ...
        $data['page_title'] = 'sayembara';       
        $url = base_url() . 'admin/sayembara_hasil/';
        $tgl=date('Y-m-d');
        $data['id_user']=$this->session->userdata('id_user');
        $data['user'] = $this->session->userdata('username');
        $data['namauser'] = $this->session->userdata('nama');
           ...
           // {
               ...
               // }
                ...
                $this->m_quiz->saveAnswer($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(site_url() . '/admin/sayembara_hasil' , 'refresh');
    ...
    function dinas_add(){
        ...
        if(!empty($_POST)){
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $this->m_dinas->add($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(site_url() . '/admin/dinas' , 'refresh');
     ...
     function dinas_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/dinas/','reload');
    }
        ...
        if(!empty($_POST))
        {
            if(!empty($_FILES['video_galeri']))
            {
                ...
                $this->m_galeri->updateVideo($data); 
                 ...
                 $this->session->set_flashdata('message', 'Data sudah disimpan');
                     $data['clear_text_box'] = 'TRUE';   
                      redirect(site_url() . '/admin/galeri' , 'refresh');
    ...
    function deletevideo($kode)
    {
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/galeri/','reload');   
    }
    ...
    function selesaikanevent()
    {
        ...
        if(!empty($_POST)){
            ...
            if(IS_TEST === 'FALSE'){
                ...
                $this->session->set_flashdata('message', 'Data sudah disimpan');
                $data['clear_text_box'] = 'TRUE';   
                redirect(site_url() . '/admin/doneevent' , 'refresh');
    ...
    function event_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/event/','reload');
    }
        ...
        if(!empty($_POST)){
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                if(IS_TEST === 'FALSE'){
                    ...
                    $this->session->set_flashdata('message', 'Data sudah disimpan');
                    $data['clear_text_box'] = 'TRUE';   
                    redirect(site_url() . '/admin/visi' , 'refresh');
            ...
            if(!empty($_POST))
            {
                ...
                if($this->form_validation->run() == TRUE)
                {
                    ...
                    $this->m_sponsor->add($data); 
                     ...
                     $this->session->set_flashdata('message', 'Data sudah disimpan');
                         $data['clear_text_box'] = 'TRUE';   
                          redirect(site_url() . '/admin/sponsor' , 'refresh');
    ...
    function sponsor_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/sponsor/','reload');
    }
            ...
            if(!empty($_POST))
            {
                ...
                if($this->form_validation->run() == TRUE)
                {
                    ...
                    $this->m_slide->updateMarque($data); 
                     ...
                     $this->session->set_flashdata('message', 'Data sudah disimpan');
                         $data['clear_text_box'] = 'TRUE';   
                          redirect(site_url() . '/admin/slidefoto' , 'refresh');
    ...
    function slide_del($kode){
        ...
        if(IS_TEST === 'FALSE'){
           ...
           redirect(site_url() . '/admin/slidefoto/','reload');
    }
    ...
    function komentar(){
     ...
     function komentar_del($kode){
        ...
        redirect(site_url() . '/admin/komentar','reload');
    }
