 <section class="content">
        <div class="">
            ...
            echo $message == '' ? '' : '<div class="alert alert-success alert-dismissible" role="alert">
                                ...
                                '.$message.'</div>';?>
                                        <form class="form-horizontal" method="POST" name="profile_edit" action="<?php echo site_url();?>/admin/myprofileedit" enctype="multipart/form-data">
            ...
            echo $message == '' ? '' : '<div class="alert alert-success alert-dismissible" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                '.$message.'</div>';?>
                                        <form id="change_password" class="form-horizontal" action="<?php echo site_url();?>/admin/password_edit" method="post">
                                            <div class="form-group">
