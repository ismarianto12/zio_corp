                                ...
                                <div class="">
                                  <div class="thumbnail">
                                      ...
                                      <div class="caption">
                                          ...
                                          <a class="btn btn-warning btn-sm" href="<?php echo site_url('admin/sponsor_edit');echo "/".$sponsor['id_sponsor'];?>">Edit</a>
                                          <a class="btn btn-danger btn-sm" href="<?php echo site_url('admin/sponsor_del');echo "/".$sponsor['id_sponsor'];?>">Delete</a>
                                      </div>
                                  </div>
                              </div>
                            <?php } ?>
