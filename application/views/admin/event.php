                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            Mading
                              <div class="right">
                                <a href="<?php echo site_url();?>/<?php echo $link; ?>/event_add" class="btn btn-sm btn-primary">Buat Mading </a>
                            </div>
                        </div>
                        <div class="body">
                            <?php  foreach($rs_event as $row): 
                                if($row['status'] == 'Selesai')
                                {
                                    $class = 'class = "body bg-green"';
                                }
                                else
                                {
                                    $class = 'class = "body bg-red"';
                                }
                            ?>      
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <?php echo $row['event_description'];?><br>
                                           ...
                                           Tanggal Mading: <?php echo $row['start_date']; ?><br>
                                           Status: <?php echo $statusa; ?><br />
                                           <?php 
                                               if($row['status'] == 'Selesai')
                                               {
                                                    ?>
                                                    Action: <a href="<?php echo site_url(); ?>/<?php echo $link; ?>/event_del/<?php echo $row['id']; ?>"><label class="label label-danger">Delete</label></a><br /> <br />
                                                    <?php
                                               }
                                               else
                                               {
                                                    ?>
                                                    Action: <a href="<?php echo site_url(); ?>/<?php echo $link; ?>/event_edit/<?php echo $row['id']; ?>"><label class="label label-warning">Edit</label></a> | <a href="<?php echo site_url(); ?>/<?php echo $link; ?>/event_del/<?php echo $row['id']; ?>"><label class="label label-danger">Delete</label></a><br /> <br />
                                                    <?php
                                               }
                                           ?>
