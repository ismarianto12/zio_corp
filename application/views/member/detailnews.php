                    ...
                    <div class="body">
                                ...
                                <div class="panel-heading">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            Admin - <?php echo $rs_news['created_at']; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php foreach($rs_detailnews as $dn => $detail){?>
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><?php echo $detail->nama; ?></h4> <?php if($this->session->userdata('id_user') != $detail->id_user) { echo 'Admin'; } else { echo 'Member'; } ?> - <?php echo $detail->tanggal_respon; ?><br />
                                        <?php
                                            if($detail->status_respon == 'Tidak')
                                            {
                                        ...
                                        <?php
                                            if($this->session->userdata('id_user') == $detail->id_user)
                                            {
                                                ?>
                                                    <a class="label label-danger" href="<?php echo site_url(); ?>/member/hapusdetailnews/<?php echo $detail->id_detailnews; ?>/<?php echo $detail->id_news; ?>">
                                                        Hapus
                                                    </a>
                                                <?php
                                            }
                        ...
                        <?php 
                            if($rs_news['status_kolom_respon'] == '')
                            {
                                ?>
