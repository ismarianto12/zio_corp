...
<nav class="navbar">
  <div class="container-fluid">
    <div class="navbar-header">
      <div align="center"><a href="javascript:void(0);" class="bars"></a> <a  href="<?php echo base_url();?>member" class="navbar-brand style1" style="width: 90%; height: 90% ">e-Jenius</a></div>
    </div>
