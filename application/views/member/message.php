                            ...
                            <div id="formpesanzzz" style="display: none; margin-left: 10px;">
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url(); ?>/member/message" class="btn btn-sm btn-danger">Tutup</a>
                                    </div>
                                </form>
                            </div>
                            <div class="messaging">
                                <div class="inbox_msg">
                                    <div class="inbox_people">
                                      ...
                                      <div class="inbox_chat">
                                        ...
                                        <a href="<?php echo site_url(); ?>/member/detailmessage/<?php echo $msg['id_message']; ?>">
                                            <div class="chat_list active_chat">
                                              <div class="chat_people">
                                                <div class="chat_img"> <img src="<?php echo base_url(); ?>assets/images/bupati/photo_profile/<?php echo $msg['user_pic']; ?>"></div>
                                                <div class="chat_ib">
                                                  <h5><?php echo $rs_user['nama']; ?><span class="chat_date"><?php echo $msg['tanggal']; ?></span></h5>
                                                  <p><?php echo $msg['pesan']; ?></p>
                                                  <a class="right" href="<?php echo site_url(); ?>/member/deletemessage/<?php echo $msg['id_message']; ?>">Hapus</a>
                                                </div>
                                              </div>
                                            </div>
                                        </a>
