...
<div class="row clearfix">
     ...
     ** ) Harap Isikan data yang di butuhkan pada form.
	 ...
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Jenisnm<?php echo form_error('jenisnm') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="jenisnm" id="jenisnm" placeholder="Jenisnm" value="<?php echo $jenisnm; ?>" />
        </div>
    </div>
	 <div class="form-group">
...
<div class='form-actions'>
 ...
 <button type="submit" class="btn btn-info"><i class='fa fa-check'></i><?php echo $button ?></button> 
	    <a href="<?php echo site_url('jenis') ?>" class="btn btn-default"><i class='fa fa-share'></i>Cancel</a>
